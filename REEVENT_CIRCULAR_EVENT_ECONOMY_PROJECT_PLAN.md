...
flowchart LR
    O["Event Organisers"]
    U["Participants and Community Users"]
    P["Circular Partners"]

    O <-->|"Rent, buy, return, repair, refurbish, recover"| P
    O <-->|"Sell, lend, donate, collect, deposit-return"| U
    U <-->|"Repair, trade-in, buy refurbished, return items"| P
    U <-->|"Exchange, lend, resell, donate"| U
    O <-->|"Share, rent, transfer resources"| O
```
