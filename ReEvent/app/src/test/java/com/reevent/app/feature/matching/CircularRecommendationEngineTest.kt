...
class CircularRecommendationEngineTest {
    ...
    private fun resource(
        ...
        title = "Test resource",
        category = "Signage",
        materialFamily = com.reevent.app.core.model.MaterialCatalog.resolveLegacy(material).family,
        materialDetail = com.reevent.app.core.model.MaterialCatalog.resolveLegacy(material).detail,
        condition = condition,
        quantity = quantity,
        unit = "ITEM",
        status = status,
    ...
    private fun programme(id: String, type: ProgrammeType, materials: List<String>, location: String = "Test location") = CircularProgramme(
        ...
        name = id,
        type = type,
        acceptedMaterialFamilies = materials.map { com.reevent.app.core.model.MaterialCatalog.resolveLegacy(it).family }.toSet(),
        location = location,
        active = true,
        createdAt = NOW,
        updatedAt = NOW
